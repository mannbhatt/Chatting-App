...
public class Server implements ActionListener{
    ...
    Server(){
        ...
        // first image in panel
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("imgs\\left-512.png")); //it is object to pass image url
        ...
        p1.add(back);                              //p1 object is used in this to add image in panel
         ...
         // second image in panel
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("imgs\\cartoon-png-31584.png")); //it is object to pass image url
        ...
        ImageIcon i7=new ImageIcon(ClassLoader.getSystemResource("imgs\\video.png")); //it is object to pass image url
        ...
        ImageIcon i10=new ImageIcon(ClassLoader.getSystemResource("imgs\\Daco_4828072.png")); //it is object to pass image url
        ...
        ImageIcon i13=new ImageIcon(ClassLoader.getSystemResource("imgs\\manu.png")); //it is object to pass image url
 ...
 text = new JTextField();    //this class is used to user can write any text 
        ...
        f.setLocation(200,20);                   // change for displaying layout position in screen
    ...
    public static JPanel formatLabel(String out){
        ...
        JLabel output =new JLabel("<html><p style=\"width:150px  \">"+out+"</p></html>");  //using html css properties with java
